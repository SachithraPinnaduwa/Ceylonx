...
const login = (e: MouseEvent) => {
 navigate("/login");
  ...
  return (
    <nav className="  py-4 flex w-full ">
      <div className="flex flex-wrap mx-[10%] ">
        <img src={logo} alt="" className="w-[257px] h-[52px] mr-6" />
      ...
      <div className="ml-auto flex flex-row gap-x-4">
       ...
       {user ? ( <button onClick={logout} className=" hover:shadow-md mr-10 bg-[#2CC84D] px-[18px] py-[9px] rounded-[6px] flex flex-row justify-center items-center border-t-2 border-white">
          <svg
            width="25"
            height="25"
            viewBox="0 0 25 25"
          ...
          <span className="text-white">LOGOUT</span>
           ...
           <button onClick={login}  className="hover:shadow-md  mr-10 bg-[#2CC84D] px-[18px] py-[9px] rounded-[6px] flex flex-row justify-center items-center border-t-2 border-white">
           <svg
             width="25"
             height="25"
             viewBox="0 0 25 25"
